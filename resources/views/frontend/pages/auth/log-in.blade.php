    ...
    <div class="d-flex flex-column flex-column-fluid flex-lg-row">
        ...
        <div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
            ...
            <div class="d-flex flex-center flex-lg-center flex-column">
                <!--begin::Logo-->
                <a href="" class="mb-7">
                    <img alt="Logo" src="{{ asset('assets/media/logos/logo-ayoub.jpg')}}" width="200px" />
                </a>
                <!--end::Logo-->

                <!--begin::Title-->
                <h2 class="text-white fw-normal m-0">
                    Connectez-vous et accéder à votre espace pour gérer vos congés en toute simplicité.
                </h2>
                <!--end::Title-->
            </div>
            <!--begin::Aside-->
...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo8/authentication/layouts/creative/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 Jun 2025 14:45:08 GMT -->
