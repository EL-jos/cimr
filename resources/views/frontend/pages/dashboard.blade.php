            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px" style="background-image:url({{ asset('assets/media/svg/shapes/top-green.png')}}" data-bs-theme="light">
                    ...
                    <h3 class="card-title align-items-start flex-column text-white pt-15">
                        <span class="fw-bold fs-2x mb-3">Compteur des congés</span>

                        <div class="fs-4 text-white">
                            <span class="opacity-75">You have</span>

                            <span class="position-relative d-inline-block">
                                <a href="javascript:;" class="link-white opacity-75-hover fw-bold d-block mb-1">4 tasks</a>
                        ...
                        <div class="row g-3 g-lg-6">
                            ...
                            <div class="col-6">
                                ...
                                <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                    ...
                                    <div class="m-0">
                                        <!--begin::Number-->
                                        <span class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{ $leaves->count() }}</span>
                                        <!--end::Number-->

                                        <!--begin::Desc-->
                                        <span class="text-gray-500 fw-semibold fs-6">Total Congés</span>
                                        <!--end::Desc-->
                                    </div>
                                    <!--end::Stats-->
                                </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                    ...
                                    <div class="m-0">
                                        <!--begin::Number-->
                                        <span class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{ \App\Models\Leave::where('status_id', 2)->get()->count() }}</span>
                                        <!--end::Number-->

                                        <!--begin::Desc-->
                                        <span class="text-gray-500 fw-semibold fs-6">Approuvés</span>
                                        <!--end::Desc-->
                                    </div>
                                    <!--end::Stats-->
                                </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                    ...
                                    <div class="m-0">
                                        <!--begin::Number-->
                                        <span class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{ \App\Models\Leave::where('status_id', 1)->get()->count() }}</span>
                                        <!--end::Number-->

                                        <!--begin::Desc-->
                                        <span class="text-gray-500 fw-semibold fs-6">En attente</span>
                                        <!--end::Desc-->
                                    </div>
                                    <!--end::Stats-->
                                </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                    ...
                                    <div class="m-0">
                                        <!--begin::Number-->
                                        <span class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{ \App\Models\Leave::where('status_id', 3)->get()->count() }}</span>
                                        <!--end::Number-->

                                        <!--begin::Desc-->
                                        <span class="text-gray-500 fw-semibold fs-6">Rejetés</span>
                                        <!--end::Desc-->
                                    </div>
                                    <!--end::Stats-->
                                </div>
                ...
                <div class="card-body d-flex ps-xl-15">
                    ...
                    <div class="m-0">
                        ...
                        <div class="position-relative fs-2x z-index-2 fw-bold text-white mb-7">
                            <span class="me-2">
                                ...
                                <span class="position-relative d-inline-block text-danger">
                                    <a href="/metronic8/demo8/pages/user-profile/overview.html" class="text-danger opacity-75-hover">2300 bonus</a>
                        ...
                        <div class="mb-3">
                            ...
                            <a href="/metronic8/demo8/apps/support-center/overview.html" class="btn btn-color-white bg-white bg-opacity-15 bg-hover-opacity-25 fw-semibold">
                                How to
                            </a>
                        </div>
                        <!--begin::Action-->
                    ...
                    <!--begin::Illustration-->
                    <img src="/metronic8/demo8/assets/media/illustrations/sigma-1/17-dark.png" class="position-absolute me-3 bottom-0 end-0 h-200px" alt="">
                    <!--end::Illustration-->
                </div>
                <!--end::Body-->
            </div>
