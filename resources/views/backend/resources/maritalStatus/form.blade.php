...
@section('main-content')
    <div class="card card-warning">
        ...
        <div class="card-body">
            <form action="{{ $maritalStatus->exists ? route('maritalStatus.update', $maritalStatus) : route('maritalStatus.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method($maritalStatus->exists ? 'PUT' : 'POST')
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <input type="text" class="form-control is-valid" name="name" id="name" placeholder="Nom ..." value="{{ $maritalStatus->exists ? $maritalStatus->name : old('name') }}">
                        </div>
                    </div>
                </div>
